...
import type { ListsResponse } from './ListsResponse';
import {
    ListsResponseFromJSON,
    ListsResponseFromJSONTyped,
    ListsResponseToJSON,
} from './ListsResponse';
...
/**
 * Check if a given object implements the ListsListResponse interface.
 */
export function instanceOfListsListResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListsListResponseFromJSON(json: any): ListsListResponse {
    return ListsListResponseFromJSONTyped(json, false);
}

export function ListsListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListsListResponse {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(ListsResponseFromJSON)),
        'totalPages': !exists(json, 'total_pages') ? undefined : json['total_pages'],
    };
}

export function ListsListResponseToJSON(value?: ListsListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(ListsResponseToJSON)),
