 ...
 * 
 * @export
 * @interface CampaignRemoveSuperRequest
 */
export interface CampaignRemoveSuperRequest {
    /**
     * 
     * @type {Array<number>}
     * @memberof CampaignRemoveSuperRequest
     */
    supervisors?: Array<number>;
}

/**
 * Check if a given object implements the CampaignRemoveSuperRequest interface.
 */
export function instanceOfCampaignRemoveSuperRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CampaignRemoveSuperRequestFromJSON(json: any): CampaignRemoveSuperRequest {
    return CampaignRemoveSuperRequestFromJSONTyped(json, false);
}

export function CampaignRemoveSuperRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignRemoveSuperRequest {
...
export function CampaignRemoveSuperRequestToJSON(value?: CampaignRemoveSuperRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
