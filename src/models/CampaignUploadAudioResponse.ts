 ...
 * 
 * @export
 * @interface CampaignUploadAudioResponse
 */
export interface CampaignUploadAudioResponse {
    /**
     * 
     * @type {string}
     * @memberof CampaignUploadAudioResponse
     */
    message?: string;
}

/**
 * Check if a given object implements the CampaignUploadAudioResponse interface.
 */
export function instanceOfCampaignUploadAudioResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CampaignUploadAudioResponseFromJSON(json: any): CampaignUploadAudioResponse {
    return CampaignUploadAudioResponseFromJSONTyped(json, false);
}

export function CampaignUploadAudioResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignUploadAudioResponse {
...
export function CampaignUploadAudioResponseToJSON(value?: CampaignUploadAudioResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
