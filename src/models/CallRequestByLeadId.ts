 ...
 * 
 * @export
 * @interface CallRequestByLeadId
 */
export interface CallRequestByLeadId {
    /**
     * 
     * @type {number}
     * @memberof CallRequestByLeadId
     */
    lead: number;
}

/**
 * Check if a given object implements the CallRequestByLeadId interface.
 */
export function instanceOfCallRequestByLeadId(value: object): boolean {
    let isInstance = true;
...
export function CallRequestByLeadIdFromJSON(json: any): CallRequestByLeadId {
    return CallRequestByLeadIdFromJSONTyped(json, false);
}

export function CallRequestByLeadIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallRequestByLeadId {
...
export function CallRequestByLeadIdToJSON(value?: CallRequestByLeadId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
