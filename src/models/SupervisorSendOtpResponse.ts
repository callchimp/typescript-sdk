 ...
 * 
 * @export
 * @interface SupervisorSendOtpResponse
 */
export interface SupervisorSendOtpResponse {
    /**
     * 
     * @type {string}
     * @memberof SupervisorSendOtpResponse
     */
    message?: string;
}

/**
 * Check if a given object implements the SupervisorSendOtpResponse interface.
 */
export function instanceOfSupervisorSendOtpResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SupervisorSendOtpResponseFromJSON(json: any): SupervisorSendOtpResponse {
    return SupervisorSendOtpResponseFromJSONTyped(json, false);
}

export function SupervisorSendOtpResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorSendOtpResponse {
...
export function SupervisorSendOtpResponseToJSON(value?: SupervisorSendOtpResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
