...
export interface CampaignRequest {
     ...
     * @memberof CampaignRequest
     */
    maxRetry: CampaignRequestMaxRetryEnum;
    /**
 ...
 * @export
 */
export const CampaignRequestMaxRetryEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2
} as const;
export type CampaignRequestMaxRetryEnum = typeof CampaignRequestMaxRetryEnum[keyof typeof CampaignRequestMaxRetryEnum];

/**
 * @export
 */
export const CampaignRequestTypeEnum = {
    Blastout: 'blastout',
    Outbound: 'outbound',
    Transactional: 'transactional'
} as const;
export type CampaignRequestTypeEnum = typeof CampaignRequestTypeEnum[keyof typeof CampaignRequestTypeEnum];


/**
 * Check if a given object implements the CampaignRequest interface.
 */
export function instanceOfCampaignRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "maxRetry" in value;
...
export function CampaignRequestToJSON(value?: CampaignRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
