 ...
 * 
 * @export
 * @interface CallReportResponseStatsInner
 */
export interface CallReportResponseStatsInner {
    /**
     * 
     * @type {Date}
     * @memberof CallReportResponseStatsInner
     */
    date?: Date;
    /**
     * 
...
/**
 * Check if a given object implements the CallReportResponseStatsInner interface.
 */
export function instanceOfCallReportResponseStatsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CallReportResponseStatsInnerFromJSON(json: any): CallReportResponseStatsInner {
    return CallReportResponseStatsInnerFromJSONTyped(json, false);
}

export function CallReportResponseStatsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallReportResponseStatsInner {
...
export function CallReportResponseStatsInnerToJSON(value?: CallReportResponseStatsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
