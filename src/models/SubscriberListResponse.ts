...
import {
    ...
    SubscriberResponseFromJSONTyped,
    SubscriberResponseToJSON,
} from './SubscriberResponse';
...
export interface SubscriberListResponse {
    ...
    /**
     * 
     * @type {Array<SubscriberResponse>}
     * @memberof SubscriberListResponse
     */
    results?: Array<SubscriberResponse>;
    /**
     * 
     * @type {number}
     * @memberof SubscriberListResponse
 ...
 */
export function instanceOfSubscriberListResponse(value: object): boolean {
    let isInstance = true;
...
export function SubscriberListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberListResponse {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(SubscriberResponseFromJSON)),
        'totalPages': !exists(json, 'total_pages') ? undefined : json['total_pages'],
    };
}

export function SubscriberListResponseToJSON(value?: SubscriberListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(SubscriberResponseToJSON)),
