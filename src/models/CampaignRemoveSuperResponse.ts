 ...
 * 
 * @export
 * @interface CampaignRemoveSuperResponse
 */
export interface CampaignRemoveSuperResponse {
    /**
     * 
     * @type {string}
     * @memberof CampaignRemoveSuperResponse
     */
    message?: string;
}

/**
 * Check if a given object implements the CampaignRemoveSuperResponse interface.
 */
export function instanceOfCampaignRemoveSuperResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CampaignRemoveSuperResponseFromJSON(json: any): CampaignRemoveSuperResponse {
    return CampaignRemoveSuperResponseFromJSONTyped(json, false);
}

export function CampaignRemoveSuperResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignRemoveSuperResponse {
...
export function CampaignRemoveSuperResponseToJSON(value?: CampaignRemoveSuperResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
