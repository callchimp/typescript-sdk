...
/**
 * Check if a given object implements the ListsRequest interface.
 */
export function instanceOfListsRequest(value: object): boolean {
    let isInstance = true;
...
export function ListsRequestFromJSON(json: any): ListsRequest {
    return ListsRequestFromJSONTyped(json, false);
}

export function ListsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListsRequest {
...
export function ListsRequestToJSON(value?: ListsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
