...
/**
 * Check if a given object implements the PhoneNumberResponse interface.
 */
export function instanceOfPhoneNumberResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PhoneNumberResponseFromJSON(json: any): PhoneNumberResponse {
    return PhoneNumberResponseFromJSONTyped(json, false);
}

export function PhoneNumberResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PhoneNumberResponse {
...
export function PhoneNumberResponseToJSON(value?: PhoneNumberResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
