 ...
 */
export function instanceOfCallListResponse(value: object): boolean {
    let isInstance = true;
...
export function CallListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallListResponse {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(CallResponseFromJSON)),
        'totalPages': !exists(json, 'total_pages') ? undefined : json['total_pages'],
    };
}

export function CallListResponseToJSON(value?: CallListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(CallResponseToJSON)),
