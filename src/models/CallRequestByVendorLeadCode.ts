 ...
 * 
 * @export
 * @interface CallRequestByVendorLeadCode
 */
export interface CallRequestByVendorLeadCode {
    /**
     * 
     * @type {string}
     * @memberof CallRequestByVendorLeadCode
     */
    vendorLeadCode: string;
}

/**
 * Check if a given object implements the CallRequestByVendorLeadCode interface.
 */
export function instanceOfCallRequestByVendorLeadCode(value: object): boolean {
    let isInstance = true;
...
export function CallRequestByVendorLeadCodeFromJSON(json: any): CallRequestByVendorLeadCode {
    return CallRequestByVendorLeadCodeFromJSONTyped(json, false);
}

export function CallRequestByVendorLeadCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallRequestByVendorLeadCode {
...
export function CallRequestByVendorLeadCodeToJSON(value?: CallRequestByVendorLeadCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
