 ...
 * 
 * @export
 * @interface CampaignAddSuperResponse
 */
export interface CampaignAddSuperResponse {
    /**
     * 
     * @type {string}
     * @memberof CampaignAddSuperResponse
     */
    message?: string;
}

/**
 * Check if a given object implements the CampaignAddSuperResponse interface.
 */
export function instanceOfCampaignAddSuperResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CampaignAddSuperResponseFromJSON(json: any): CampaignAddSuperResponse {
    return CampaignAddSuperResponseFromJSONTyped(json, false);
}

export function CampaignAddSuperResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignAddSuperResponse {
...
export function CampaignAddSuperResponseToJSON(value?: CampaignAddSuperResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
