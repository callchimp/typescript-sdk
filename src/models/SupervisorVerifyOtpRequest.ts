 ...
 * 
 * @export
 * @interface SupervisorVerifyOtpRequest
 */
export interface SupervisorVerifyOtpRequest {
    /**
     * 
     * @type {number}
     * @memberof SupervisorVerifyOtpRequest
     */
    otp?: number;
}

/**
 * Check if a given object implements the SupervisorVerifyOtpRequest interface.
 */
export function instanceOfSupervisorVerifyOtpRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SupervisorVerifyOtpRequestFromJSON(json: any): SupervisorVerifyOtpRequest {
    return SupervisorVerifyOtpRequestFromJSONTyped(json, false);
}

export function SupervisorVerifyOtpRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorVerifyOtpRequest {
...
export function SupervisorVerifyOtpRequestToJSON(value?: SupervisorVerifyOtpRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
