 ...
 * 
 * @export
 * @interface CallReportResponseAnsweredCalls
 */
export interface CallReportResponseAnsweredCalls {
    /**
     * 
     * @type {number}
     * @memberof CallReportResponseAnsweredCalls
     */
    current?: number;
    /**
     * 
...
/**
 * Check if a given object implements the CallReportResponseAnsweredCalls interface.
 */
export function instanceOfCallReportResponseAnsweredCalls(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CallReportResponseAnsweredCallsFromJSON(json: any): CallReportResponseAnsweredCalls {
    return CallReportResponseAnsweredCallsFromJSONTyped(json, false);
}

export function CallReportResponseAnsweredCallsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallReportResponseAnsweredCalls {
...
export function CallReportResponseAnsweredCallsToJSON(value?: CallReportResponseAnsweredCalls | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
