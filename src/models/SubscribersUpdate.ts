 ...
 * 
 * @export
 * @interface SubscribersUpdate
 */
export interface SubscribersUpdate {
    /**
     * 
     * @type {string}
     * @memberof SubscribersUpdate
     */
    firstName?: string;
}

/**
 * Check if a given object implements the SubscribersUpdate interface.
 */
export function instanceOfSubscribersUpdate(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SubscribersUpdateFromJSON(json: any): SubscribersUpdate {
    return SubscribersUpdateFromJSONTyped(json, false);
}

export function SubscribersUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscribersUpdate {
...
export function SubscribersUpdateToJSON(value?: SubscribersUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
