 ...
 * 
 * @export
 * @interface CampaignAddSuperRequest
 */
export interface CampaignAddSuperRequest {
    /**
     * 
     * @type {Array<number>}
     * @memberof CampaignAddSuperRequest
     */
    supervisors?: Array<number>;
}

/**
 * Check if a given object implements the CampaignAddSuperRequest interface.
 */
export function instanceOfCampaignAddSuperRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CampaignAddSuperRequestFromJSON(json: any): CampaignAddSuperRequest {
    return CampaignAddSuperRequestFromJSONTyped(json, false);
}

export function CampaignAddSuperRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignAddSuperRequest {
...
export function CampaignAddSuperRequestToJSON(value?: CampaignAddSuperRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
