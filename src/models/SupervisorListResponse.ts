...
import {
    ...
    SupervisorResponseFromJSONTyped,
    SupervisorResponseToJSON,
} from './SupervisorResponse';
...
export interface SupervisorListResponse {
     ...
     * 
     * @type {number}
     * @memberof SupervisorListResponse
     */
    count?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<SupervisorResponse>}
     * @memberof SupervisorListResponse
     */
    results?: Array<SupervisorResponse>;
    /**
     * 
     * @type {number}
     * @memberof SupervisorListResponse
...
/**
 * Check if a given object implements the SupervisorListResponse interface.
 */
export function instanceOfSupervisorListResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SupervisorListResponseFromJSON(json: any): SupervisorListResponse {
    return SupervisorListResponseFromJSONTyped(json, false);
}

export function SupervisorListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorListResponse {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(SupervisorResponseFromJSON)),
        'totalPages': !exists(json, 'total_pages') ? undefined : json['total_pages'],
    };
}

export function SupervisorListResponseToJSON(value?: SupervisorListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(SupervisorResponseToJSON)),
