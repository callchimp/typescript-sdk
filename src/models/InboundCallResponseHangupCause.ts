 ...
 * 
 * @export
 * @interface InboundCallResponseHangupCause
 */
export interface InboundCallResponseHangupCause {
}

/**
 * Check if a given object implements the InboundCallResponseHangupCause interface.
 */
export function instanceOfInboundCallResponseHangupCause(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function InboundCallResponseHangupCauseFromJSON(json: any): InboundCallResponseHangupCause {
    return InboundCallResponseHangupCauseFromJSONTyped(json, false);
}

export function InboundCallResponseHangupCauseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboundCallResponseHangupCause {
    return json;
}

export function InboundCallResponseHangupCauseToJSON(value?: InboundCallResponseHangupCause | null): any {
    return value;
}
