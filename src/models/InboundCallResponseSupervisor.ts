 ...
 * 
 * @export
 * @interface InboundCallResponseSupervisor
 */
export interface InboundCallResponseSupervisor {
    /**
     * 
     * @type {number}
     * @memberof InboundCallResponseSupervisor
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the InboundCallResponseSupervisor interface.
 */
export function instanceOfInboundCallResponseSupervisor(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function InboundCallResponseSupervisorFromJSON(json: any): InboundCallResponseSupervisor {
    return InboundCallResponseSupervisorFromJSONTyped(json, false);
}

export function InboundCallResponseSupervisorFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboundCallResponseSupervisor {
...
export function InboundCallResponseSupervisorToJSON(value?: InboundCallResponseSupervisor | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
